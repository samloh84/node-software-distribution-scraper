...
var versions = ['2.7.12', '3.3.6', '3.4.5', '3.5.2', '3.6.0b1', '3.6.0a4'];
...
var promise = Promise.map(versions, function (version) {
    ...
    var sourceUrl = _.get(versionUrls, ['source', 'tgz', 'url']);
    var signatureUrl = _.get(versionUrls, ['source', 'tgz', 'signatureUrl']);
    return Promise.all([
