...
var language = /([-_a-zA-Z0-9]+)-generate-dockerfiles/.exec(_path.basename(__filename, '.js'))[1];
...
var promise = Promise.map(_.toPairs(urls.jdk), function (versionPair) {
    ...
    var templateData = _.merge({}, versionData, {
        ...
        registry: registry,
        username: username,
        jce: urls.jce[versionData.binaries.jceVersion]
    });
